...
public class EncryptionConfiguration {
    ...
    public Integer getInitialVectorSize() {
        ...
        if (initialVectorSize != null) return Integer.parseInt(initialVectorSize);
    ...
    private PropertiesManager getEncryptionProps() {
        if (encryptionProps == null) encryptionProps = new PropertiesManager(ENCRYPTION_PROPS_FILE_NAME);
